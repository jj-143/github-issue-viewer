...
export const response = {
  ...
  items: Array.from(Array(30)).map((_, idx) => ({
    ...sampleItem,
    id: idx,
    name: `${sampleItem.name}_${idx}`, // Tetris_0 .. Tetris_29
    full_name: `${sampleItem.full_name}_${idx}`, // dtrupenn/Tetris_0 .. dtrupenn/Tetris_29
  })),
};
